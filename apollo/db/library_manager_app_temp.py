...
from apollo.gui.ui_library_manager_ui import Ui_MainWindow
from apollo.db.library_manager import LibraryManager
from apollo.app.misc_app import FileExplorer
from apollo.gui.ui_LEDT_dialog import LEDT_Dialog
...
class LibraryManagerTab:
    ...
    def __init__(self, UI, Setup = True):
        """
        Library Manager Tab
